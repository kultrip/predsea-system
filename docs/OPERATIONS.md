...
| **`alboran_1km`** | $[35.0^\circ\text{N}, 37.5^\circ\text{N}], [-6.0^\circ\text{E}, -1.0^\circ\text{E}]$ | $124,203$ | `c2d-highcpu-16` | `croco-batch:20260726-v20` |
| **`gulf_of_lion_1km`** | $[41.0^\circ\text{N}, 44.0^\circ\text{N}], [3.0^\circ\text{E}, 7.5^\circ\text{E}]$ | $121,649$ | `c2d-highcpu-16` | `croco-batch:20260726-v20` |
| **`tyrrhenian_1km`** | $[37.0^\circ\text{N}, 43.5^\circ\text{N}], [9.5^\circ\text{E}, 16.0^\circ\text{E}]$ | $391,379$ | `c2d-highcpu-16` | `croco-batch:20260726-v20` |
| **`algerian_1km`** | $[35.5^\circ\text{N}, 38.0^\circ\text{N}], [-2.0^\circ\text{E}, 8.5^\circ\text{E}]$ | $282,273$ | `c2d-highcpu-16` | `croco-batch:20260726-v20` |
